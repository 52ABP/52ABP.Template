...
namespace LTMCompanyNameFree.YoyoCmsTemplate.EntityFrameworkCore.Repositories
{
    /// <summary>
    ...
    public abstract class YoyoCmsTemplateRepositoryBase<TEntity, TPrimaryKey> : EfCoreRepositoryBase<YoyoCmsTemplateDbContext, TEntity, TPrimaryKey>
